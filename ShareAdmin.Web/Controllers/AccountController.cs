...
using ShareAdmin.Sessions;
using ShareAdmin.Web.Controllers.Results;
using ShareAdmin.Web.Models;
using ShareAdmin.Web.Models.Account;
...
{
    public class AccountController : ShareAdminControllerBase
    {
